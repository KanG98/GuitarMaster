...
export const CHORDS: ChordDefinition[] = [
  ...
  { id: "Cmaj7_v3", name: "Cmaj7", root: "C", quality: "maj7", position: "3fr",
    strings: [null, 3, 5, 4, 5, 3], fingers: [null, 1, 3, 2, 4, 1], baseFret: 3,
    barres: [{ fret: 3, fromString: 1, toString: 5 }] },
  { id: "Cmaj7_v4", name: "Cmaj7", root: "C", quality: "maj7", position: "5fr",
    strings: [null, null, 5, 5, 5, 7], fingers: [null, null, 1, 1, 1, 3], baseFret: 5,
    barres: [{ fret: 5, fromString: 2, toString: 4 }] },
  { id: "Cmaj7_v5", name: "Cmaj7", root: "C", quality: "maj7", position: "7fr",
    strings: [null, null, 7, 9, 8, 7], fingers: [null, null, 1, 3, 2, 1], baseFret: 7,
    barres: [{ fret: 7, fromString: 2, toString: 5 }] },
  { id: "Cmaj7_v6", name: "Cmaj7", root: "C", quality: "maj7", position: "8fr",
    strings: [8, 8, 9, 9, 8, 8], fingers: [1, 1, 2, 3, 1, 1], baseFret: 8,
    barres: [{ fret: 8, fromString: 0, toString: 5 }] },
  { id: "Cmaj7_v7", name: "Cmaj7", root: "C", quality: "maj7", position: "Open (v3)",
    strings: [null, 3, 2, 0, 0, 3], fingers: [null, 3, 2, null, null, 4], baseFret: 1 },
  { id: "Cmaj7_v8", name: "Cmaj7", root: "C", quality: "maj7", position: "4fr",
    strings: [null, null, 5, 4, 5, 3], fingers: [null, null, 3, 2, 4, 1], baseFret: 3 },
